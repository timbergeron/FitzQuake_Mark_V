/* This file is NOT done yet.  Reminaing input issues.

Versus Quakespasm: 

1. I dislike the idea of supporting a separate key for OS X (Key Command)
   because a Mac keyboard is identical.  Thinking about right solution
   which could involve just printing them differently on a Mac, but keeping
   same internal names.  Thinking some more ...
...
#define		CMDLINES	64 // Was 32 ... increased to 64
