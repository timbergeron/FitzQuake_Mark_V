/* Versus Quakespasm:  Nothing of substance.*/
/*
...
typedef struct
{
	...
	sizebuf_t	datagram;
	byte		datagram_buf[MAX_FITZQUAKE_DATAGRAM];

	sizebuf_t	reliable_datagram;	// copied to all clients at end of frame
	byte		reliable_datagram_buf[MAX_FITZQUAKE_DATAGRAM];

	sizebuf_t	signon;
	byte		signon_buf[MAX_FITZQUAKE_MSGLEN-2]; //johnfitz -- was 8192, now uses MAX_MSGLEN
...
typedef struct client_s
{
	...
	byte			msgbuf[MAX_FITZQUAKE_MSGLEN];
...
extern	cvar_t	sv_cullentities; //Baker
extern	cvar_t	sv_imp12hack; // Baker from JDH and Requiem
extern	cvar_t	sv_fishfix; // Baker from JDH and Requiem

extern  cvar_t  sv_external_ents;
