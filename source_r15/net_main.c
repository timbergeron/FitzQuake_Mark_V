...
1. ProQuake: qflood/qkick protection (connecttimeoutcvar)
...
cvar_t	net_connecttimeout = {"net_connecttimeout","10",CVAR_NONE};	// From ProQuake - qkick/qflood protection
...
void NET_Init (void)
{
	...
	SZ_Alloc (&net_message, NET_FITZQUAKE_MAXMESSAGE);
