...
1. Support for many texture effects
2. Anti-wallhack
3. Non-colormapped entities list
...
#define SURF_DRAWTELEPORTER 0x200
#define SURF_DRAWFENCE		0x400 // Not implemented
#define SURF_DRAWENVMAP     0x800
#define SURF_SCROLLX		0x1000 // Not implemented
#define SURF_SCROLLY		0x2000 // Not implemented
#define SURF_DRAWMIRROR		0x4000 // Not implemented

#ifdef SUPPORTS_TEXTURE_POINTER
#define SURF_SELECTED		0x8000
#endif // Baker change + SUPPORTS_TEXTURE_POINTER
...
#define MOD_NOCOLORMAP	2048	// don't bother colormapping certain entities (wasteful)
//johnfitz
...
extern cvar_t model_external_vis;
