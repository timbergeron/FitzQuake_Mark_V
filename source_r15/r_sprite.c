...
1. I'm not sure why the R_DrawSprite "no such frame" message has been made a 
   DPrint in Quakespasm.  That message is extremely rare and usual indicates
   not having all the files you need (wrong sprite).

2. cl.ctime (demo rewind support)
