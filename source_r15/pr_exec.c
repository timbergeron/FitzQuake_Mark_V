...
1. fix for "profile" command crash.  Type "profile" in as a client only = crash.

Quakespasm has things here which I don't understand since I'm not
super-familiar with all aspects of the QuakeC byte interpreter stuff
going on here.  Investigate further ...
